...
export const esES: LocalizationResource = {
    ...
    unstable__errors: {
        ...
        zxcvbn: {
            couldBeStronger: 'Tu contraseña esta bien, pero podria ser mas segura. Intenta añadir mas caracteres.',
            goodPassword: 'Tu contraseña cumple con todos los requerimientos necesarios.',
